...
[<Fact>]
let ``Day14 Part1`` () =
    let answer = Day14.Part1.solution "Day14.txt"
    let expected = 2587//1588
    Assert.Equal(expected,answer)
    
[<Fact>]
let ``Day15 Part1`` () =
    let answer = Day15.Part1.solution "Day15.txt"
    let expected = 540//40
    Assert.Equal(expected,answer)

[<Fact>]
let ``Day15 Part2`` () =
    let answer = Day15.Part2.solution "Day15.txt"
    let expected = 2879//315
    Assert.Equal(expected,answer)

[<Fact>]
let ``Day17 Part1`` () =
    let answer = Day17.Part1.solution "Day17.txt"
    let expected = 7750//45
    Assert.Equal(expected,answer)